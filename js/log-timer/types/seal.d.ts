declare namespace seal {
  ...
  export const vars: {
    intGet(ctx: MsgContext, s: string): [number, boolean];
    intSet(ctx: MsgContext, s: string, v: number): void;
    strGet(ctx: MsgContext, s: string): [string, boolean];
    strSet(ctx: MsgContext, s: string, v: string): void;
  }
}
